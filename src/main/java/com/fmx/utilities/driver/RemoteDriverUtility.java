package com.fmx.utilities.driver;

import com.fmx.utilities.capabilities.FMXCapabilities;
...
public class RemoteDriverUtility implements DriverUtility {
    ...
    private DesiredCapabilities getCapabilities(Map<String, String> executionEnvironment) {
        FMXCapabilities capabilities = new FMXCapabilities().remote(SELENIUM_REMOTE_BROWSER);

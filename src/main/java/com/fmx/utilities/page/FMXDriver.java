...
import com.fmx.utilities.logger.Logger;
...
public class FMXDriver {
    ...
    public FMXDriver(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public String getFMXUrl() {
        return System.getProperty("production", "https://gofmx.com");
    }

package com.nayya.pages.getDemoPage;
...
public class DemoRequestForm implements BasePage, PageNavigation {
    ...
    public DemoConfirmationPage submitDemoRequestForm() {
        ...
        driver.setText(workEmailAddressField, "thomas+nayyaqa_" + timestamp + "@tsouth.me");
...
The next step that's built out is an assertion on the "Thank you" confirmation page that is shown after form submit.
This function is called "Verify appointment request" on the DemoConfirmationPage.java
 */

...
import com.songTradr.utilities.capabilities.SongTradrCapabilities;
...
public class RemoteDriverUtility implements DriverUtility {
    ...
    private DesiredCapabilities getCapabilities(Map<String, String> executionEnvironment) {
        SongTradrCapabilities capabilities = new SongTradrCapabilities().remote(SELENIUM_REMOTE_BROWSER);
